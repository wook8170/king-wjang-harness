...
| Test suite | **1327 passing** (54 files) — 17 are repo-only checks that skip in the published package (1310 there) |
...
**v0.1.0 — core engine, gates, and both later tracks are implemented and measured** (1327 tests). The
