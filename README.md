...
| Test suite | **1364 passing** (57 files) — 17 are repo-only checks that skip in the published package (1347 there) |
...
**v0.1.0 — core engine, gates, and both later tracks are implemented and measured** (1364 tests). The
