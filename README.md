...
| Test suite | **1268 passing** (53 files) — 16 are repo-only checks that skip in the published package (1252 there) |
...
**v0.1.0 — core engine, gates, and both later tracks are implemented and measured** (1268 tests). The
