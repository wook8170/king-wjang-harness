...
| Test suite | **1340 passing** (55 files) — 17 are repo-only checks that skip in the published package (1323 there) |
...
**v0.1.0 — core engine, gates, and both later tracks are implemented and measured** (1340 tests). The
