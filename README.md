...
| Test suite | **1400 passing** (57 files) — 17 are repo-only checks that skip in the published package (1360 there) |
...
**v0.1.0 — core engine, gates, and both later tracks are implemented and measured** (1400 tests). The
