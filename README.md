...
| Test suite | **1257 passing** (53 files) — 16 are repo-only checks that skip in the published package (1241 there) |
...
**v0 — core engine, gates, and both later tracks are implemented and measured** (1257 tests). The
