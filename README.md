...
| Test suite | **1296 passing** (54 files) — 17 are repo-only checks that skip in the published package (1279 there) |
...
**v0.1.0 — core engine, gates, and both later tracks are implemented and measured** (1296 tests). The
