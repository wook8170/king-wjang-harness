...
| Test suite | **1361 passing** (56 files) — 17 are repo-only checks that skip in the published package (1344 there) |
...
**v0.1.0 — core engine, gates, and both later tracks are implemented and measured** (1361 tests). The
